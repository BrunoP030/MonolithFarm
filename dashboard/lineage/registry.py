...
for _name, _feature_type, _definition, _table, _function, _raw_sources, _source_columns, _transformation, _csvs, _hypotheses, _charts in [
    (
        "dense_veg_pct_week",
        "agregada",
        "Vegetação densa média da semana.",
        "pairwise_weekly_features",
        "build_ndvi_weekly",
        ["data/OneSoil - Imagens de Satélite/CSV/ndvi_metadata.csv"],
        ["dense_veg_pct"],
        "média semanal por season_id e week_start",
        ["weekly_correlations.csv"],
        ["H1", "H4"],
        ["ndvi_weekly_by_area", "correlations"],
    ),
    (
        "precipitation_mm_week",
        "agregada",
    ...
    (
        "water_balance_mm_week",
        "derivada",
        "Balanço hídrico semanal: chuva menos evapotranspiração.",
        "weather_weekly",
        "build_weather_weekly",
        ["data/Metos - Estação Meteorológica/CSV/*.csv"],
        ["precipitation_mm", "evapotranspiration_mm"],
        "water_balance_mm = precipitation_mm - evapotranspiration_mm; depois soma semanal",
        ["weekly_correlations.csv"],
        ["H3", "H4"],
        ["correlations", "drivers_problem_weeks"],
    ),
    (
        "temp_avg_c_week",
        "agregada",
        ...
        "média semanal da temperatura média diária",
        ["weekly_correlations.csv"],
        ["H3", "H4"],
        ["correlations"],
    ),
    (
        "humidity_avg_pct_week",
        "agregada",
        "Umidade relativa média semanal.",
        "weather_weekly",
        "build_weather_weekly",
        ["data/Metos - Estação Meteorológica/CSV/*.csv"],
        ["Umidade Rel. Média (%)", "humidity_avg_pct"],
        "média semanal da umidade relativa média diária",
        ["weekly_correlations.csv"],
        ["H3", "H4"],
        ["correlations"],
    ),
    (
        "avg_pest_count_week",
        "agregada",
        "Contagem média semanal de pragas por área.",
        "pairwise_weekly_features",
        "_build_miip_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Pest/*.csv"],
        ["pestCount", "avg_pest_count"],
        "média semanal da contagem diária atribuída à área",
        ["event_driver_lift.csv", "weekly_correlations.csv"],
        ["H3", "H4"],
        ["drivers_problem_weeks", "correlations"],
    ),
    (
        "harvest_yield_mean_kg_ha",
        "agregada",
        "Produtividade média diária de colheita por área.",
        "ops_area_daily",
        "_summarize_harvest_daily",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_GRAIN_HARVESTING.csv"],
        ["Yield - kg/ha"],
        "média diária de Yield - kg/ha depois da atribuição espacial à área",
        ["dataset_overview.csv"],
        ["H4"],
        ["outlook_pre_harvest"],
    ),
    (
        "harvest_yield_mean_kg_ha_week",
        "agregada",
        "Produtividade média semanal de colheita por área.",
        "pairwise_weekly_features",
        "_build_ops_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_GRAIN_HARVESTING.csv"],
        ["harvest_yield_mean_kg_ha", "Yield - kg/ha"],
        "média semanal da produtividade diária de colheita",
        ["pair_weekly_gaps.csv"],
        ["H4"],
        ["gap_weekly", "outlook_pre_harvest"],
    ),
    (
        "planting_population_mean_ha",
        "agregada",
        "População média de plantio por hectare.",
        "ops_area_daily",
        "_summarize_planting_daily",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_PLANTING.csv"],
        ["Population - ha"],
        "média diária de Population - ha depois da atribuição espacial à área",
        [],
        ["H3", "H4"],
        ["correlations"],
    ),
    (
        ...
        "agregada",
        "Desvio absoluto médio semanal entre dose aplicada e dose configurada na adubação.",
        "pairwise_weekly_features",
        "_build_ops_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_FERTILIZATION.csv"],
        ["AppliedDos - kg/ha", "Configured - kg/ha"],
        "abs(AppliedDos - kg/ha - Configured - kg/ha), agregado por semana",
        ["event_driver_lift.csv", "weekly_correlations.csv"],
        ["H3", "H4"],
        ["drivers_problem_weeks", "correlations"],
    ),
    (
        ...
        "agregada",
        "Sobreposição operacional semanal normalizada pela área aproximada do bbox NDVI.",
        "pairwise_weekly_features",
        "_build_ops_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_OVERLAP.csv"],
        ["OverlapArea - ha", "bbox_area_ha"],
        "soma de OverlapArea - ha dividida pela área do bbox do NDVI",
        ["event_driver_lift.csv", "weekly_correlations.csv"],
        ["H3", "H4"],
        ["drivers_problem_weeks", "correlations"],
    ),
    (
        ...
        "agregada",
        "Horas de parada semanal por hectare aproximado do bbox NDVI.",
        "pairwise_weekly_features",
        "_build_ops_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_STOP_REASON.csv"],
        ["Duration - h", "bbox_area_ha"],
        "soma de Duration - h dividida pela área do bbox do NDVI",
        ["event_driver_lift.csv", "weekly_correlations.csv"],
        ["H3", "H4"],
        ["drivers_problem_weeks", "correlations"],
    ),
    (
        ...
        "agregada",
        "Proporção semanal de comunicação inválida na telemetria.",
        "ops_support_weekly",
        "build_ops_support_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_TELEMETRY_COMMUNICATION.csv"],
        ["InvalidCommunication"],
        "média semanal da proporção diária de comunicação inválida",
        ["event_driver_lift.csv", "weekly_correlations.csv"],
        ["H3", "H4"],
        ["drivers_problem_weeks", "correlations"],
    ),
    (
        "alarm_events_week",
        "agregada",
        "Quantidade semanal de alarmes de máquina.",
        "ops_support_weekly",
        "build_ops_support_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_ALARM.csv"],
        ["Alarm"],
        "soma semanal de eventos de alarme",
        ["event_driver_lift.csv", "weekly_correlations.csv"],
        ["H3", "H4"],
        ["drivers_problem_weeks", "correlations"],
    ),
    (
        ...
        "agregada",
        "Proporção semanal de pontos com temperatura de motor alta.",
        "ops_support_weekly",
        "build_ops_support_weekly",
        ["data/EKOS - Telemetria e Armadilhas Eletrônicas/CSV/Layers/LAYER_MAP_ENGINE_TEMPERATURE.csv"],
        ["EngineTemperature - ºC"],
        "proporção semanal de leituras acima do limiar interno de temperatura do motor",
        ["event_driver_lift.csv", "weekly_correlations.csv"],
        ["H3", "H4"],
        ["drivers_problem_weeks", "correlations"],
    ),
    ...
    FEATURE_REGISTRY[_name] = FeatureSpec(
        ...
        table_where_born=_table,
        module="farmlab.pairwise" if _function.startswith("_") or _function.startswith("build_weather") else "farmlab.ndvi_deepdive",
        function=_function,
        file_path="farmlab/pairwise.py" if _function.startswith("_") or _function.startswith("build_weather") else "farmlab/ndvi_deepdive.py",
        raw_sources=_raw_sources,
        source_columns=_source_columns,
        transformation=_transformation,
        filters_involved=["atribuição espacial por season_id quando a fonte é EKOS", "agregação temporal por date/week_start"],
        appears_in_tables=[_table, "pairwise_weekly_features", "ndvi_phase_timeline", "transition_model_frame"],
        appears_in_csvs=_csvs,
        related_hypotheses=_hypotheses,
        related_charts=_charts,
    )
