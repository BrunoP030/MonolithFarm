...
from dashboard.workspace import apply_manual_mapping, summarize_costs
from farmlab.config import COST_INPUT_COLUMNS, DEFAULT_DATA_DIR, SEASON_MAPPING_COLUMNS
from dashboard.database import DEFAULT_DB_PATH, ensure_workspace
...
def _inject_theme() -> None:
    css_path = Path(__file__).resolve().parents[1] / ".streamlit" / "custom.css"
    if css_path.exists():
