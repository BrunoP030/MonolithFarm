...
def write_markdown_report(
    ...
    *,
    ...
    lines = [
        ...
        "## Status",
        "",
        "Cobertura suficiente para analise exploratoria e insuficiente para inferencia formal completa.",
        "",
        "A fase 1 permite comparacoes exploratorias com base em NDVI, operacao e MIIP.",
        "A base ainda nao permite inferencia economica, causalidade fechada entre manejo e produtividade, ou conclusao sobre resistencia de insetos.",
        "",
        "## Inventario",
        "",
        ...
        "- O projeto ja mostra diferencas em sinais operacionais e de monitoramento, mas nao fecha a comparacao economica em R$/ha.",
        "- Os dados atuais nao demonstram resistencia de insetos a agrotoxicos. Os registros apontam padroes de pressao e possiveis falhas operacionais que exigem validacao agronomica.",
        "",
        "## Evidencia Por Par",
        "",
    ]
